    ...
    const processResults = async () => {
      for (const result of pendingResults) {
        ...
        switch (toolName) {
          ...
          /////////////////////////////////////////////////////////////////////////
          // 5. Handle WORLDPOP POPULATION ANALYSIS
          /////////////////////////////////////////////////////////////////////////
          case "requestWorldPopPopulationAnalysis": {
            const {
              analysisType,
              country,
              year1,
            ...
            startTransition(() => {
              ...
              // Add a map layer for population data visualization
              if (data && data.geospatial) {
                addMapLayer({
                  id: generateUUID(),
                  layerFunctionType: analysisType,
                  name: `Population Analysis - ${country}`,
                  visible: true,
                  type: "raster",
                  mapStats: {
                  ...
                  roiName: selectedRoiGeometryInChat?.name || "",
                });
              }
            });
            break;
